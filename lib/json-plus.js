...
function postprocess(jpData, handlers) {
    ...
    function toJS(obj) {
        if (obj.type === "Array") {
            return obj.elements.map(cachedToJS);
        }
        if (obj.type === "String") {
            return obj.value;
        }
...
function stringify(jsObj, objectHandler, indent) {
    var push = '';
    var spc = '';
    if (indent) {
    ...
    function stringifier(obj) {
        ...
        if (obj.toJsonPlus instanceof Function) {
            return obj.toJsonPlus(indent);
        }
        if (objectHandler) {
            return objectHandler(obj);
        }
        return JSON.stringify(obj, objectHandler, indent);
    }
    function ref(obj) {
        return '@' + guid(obj);
    }
